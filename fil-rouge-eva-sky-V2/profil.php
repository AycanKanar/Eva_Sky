...
if (isset($_GET['id']) and $_GET['id'] > 0) {
    ...
    $date = date("d/m/y à H:m", strtotime($_SESSION['date_creation']));
?>
    <!DOCTYPE html>
    <html lang="fr">
    <head>
    ...
    <body>
        ...
        <section id="profile">
            <div>
                <img src="https://mc-heads.net/avatar/<?php echo $_SESSION['pseudo_user']; ?>/40.png" alt="Profil Icon" class="avatar-lg">
                <h2>
                    Mon profil
                </h2>
            </div>
                        ...
                        <div>
                            <div>
                                ...
                                <div>
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $_SESSION['pseudo_user']; ?>" disabled>
                                </div>
                            </div>
                            <div>
                                <h6>
